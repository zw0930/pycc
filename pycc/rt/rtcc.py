...
class rtcc(object):
    ...
    def dipole(self, t1, t2, l1, l2, withref = True, magnetic = False, real_time = False):
        """
        Parameters
        ----------
        ...
        if self.ccwfn.model == 'CC3':
            (opdm, opdm_cc3) = self.ccdensity.compute_onepdm(t1, t2, l1, l2, withref=withref, real_time=real_time)
        else:
